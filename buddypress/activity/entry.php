...
<!-- <a href="<?php bp_activity_user_link(); ?>" class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>"> -->
<div class="vkpb-card-item <?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>">
	...
	<div>
		...
		<?php if ( bp_activity_has_content() ) : ?>
			...
			<a class="button" href="<?php bp_activity_user_link(); ?>">View Activity</a>
